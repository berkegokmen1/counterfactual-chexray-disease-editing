...
from chexzero.util.model_utils import BaseModel, BaseModelConfig, MainModelConfig
...
class ChexzeroTextEncoder(BaseModel):
    ...
    def forward(self, input_ids: torch.Tensor, project: bool = True, **kwargs) -> Tensor:
